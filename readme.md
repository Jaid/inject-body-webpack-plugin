...
```bash
npm install --save-dev inject-body-webpack-plugin@^1.0.0
```
...
```bash
yarn add --dev inject-body-webpack-plugin@^1.0.0
```
...
```bash
npm install --save-dev @jaid/inject-body-webpack-plugin@^1.0.0
```
